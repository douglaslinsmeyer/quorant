...
func TestCreateAssessment_PostsJournalEntry(t *testing.T) {
	...
	svc := fin.NewFinService(assessments, payments, budgets, funds, collections, glService, fin.NewGaapEngine(nil, nil, fin.EngineConfig{}), ai.NewNoopPolicyResolver(), ai.NewNoopComplianceResolver(), nil, logger, nil)
