...
var ifrsChartOfAccounts = []GLAccountSeed{
	...
	{Number: 3000, Name: "Equity", Type: GLAccountTypeEquity, IsHeader: true, IsSystem: true},
	...
	{Number: 3010, ParentNum: 3000, Name: "Retained Earnings", Type: GLAccountTypeEquity, IsSystem: true},
